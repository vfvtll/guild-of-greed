...
public partial class GameData : Node
{
	...
	public static readonly string[] LocationNames =
	{
		...
		"Звериная балка",
		"Разбойничья застава",
		"Каменоломня Гримсхольд",
		"Полузатопленный храм",
		"Холмы Когтя",
		"Турнирная ставка Каркаса",
	};
	...
	public static readonly string[] LocationHints =
	{
		...
		"Заброшенный карьер, занятый бандой контрабандистов.\nD-грейд кач, рядовые бьют 40-50. Босс — надзиратель.",
		"Низинный храм, занятый раскольнической сектой.\nМагия + тяжёлые стражи, до 4 врагов в пачке. Босс — иерарх.",
		"Горный хребет: гризли, рыцари-затворники, болотные чары.\n10 рядов, мобы 60-80 урона. Босс — альфа-гризли.",
		"Подпольная арена Каркаса.\nКороткая (4 ряда) но смертельно сложная.\nПобеда даёт C-грейд автоматически.",
	};
	...
	// 5+ ур. D-grade локации требуют 21+. Турнирная ставка (C-trial) — 38+,
	// победа над её боссом даёт C-грейд (см. Session.HandleBattleAction).
	// UI блокирует "Войти →" пока перс не дорос (LocationSelectView).
